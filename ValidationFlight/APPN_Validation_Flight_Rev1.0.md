__Validation Test Flight Procedure__

__Version 1\.0 – April 2026__
...
- *At regular intervals *__*\(exact interval tbd\)*__* by all node to check sensors are still comparable*
...
__Standard Validation Flight – GOBI & CALViS__
...
![](APPN_Validation_Flight_Rev1.0_media/image_df0114ae9e97.png)__IF1200 \+ CALVIS or GOBI__
...
2. __INSERT EXPOSURE SETTING PROCEDURE__

__DJI M350 RTK \+ GOBI__
...
1. __EXPOSURE SETTING PROCEDURE __

__Potential Experiments__
...
__*Post cali week*__

1. __UWA\-DPIRD?__ Crosstrack illumination \- April
	1. Panels setup in the middle and edge of the flight lines
	2. Very high flights seem to be more pronounced
2. __UQ\-CSU?__ Flight orientation \(should be done in fully closed crop canopy\)
	1. Default is N\-S
	2. E\-W
	3. NE\-SW
	4. NW\-SE

__*Extras and post processing experiments*__
...
- Test different __wind speed and climate conditions__ \(may not be an experiment if we set up high frequency weather station at every location then data mine post season\)
	- 
